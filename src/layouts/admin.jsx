        ...
        <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
          <div className="flex flex-wrap justify-between items-center">
            ...
            <div className="flex items-center lg:order-2">
              ...
              <Link to={""} 
              className="text-white bg-blue-700 hover:bg-blue-500 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2  focus:outline-none ">
                {userInfo.name}
              </Link>
              <button
                type="button"
        ...
        >
          <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            ...
            <ul className="pt-5 mt-5 space-y-2 borderT border-gray-200 dark:border-gray-700">
              ...
              <li>
              <button onClick={handleLogout} className="flex items-center p-2 text-base font-medium text-white rounded-lg transition duration-75 hover:bg-red-500 ">
